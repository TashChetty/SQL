...
--Try it yourseld Chapter 02

SELECT * FROM teachers;

--Question 1
--schools A-Z & Teacher by associated school A-Z
SELECT school, last_name FROM teachers
ORDER BY school ASC , last_name ASC;

--Question 2
--1 Teacher with first name starting with S earning > 40000
-- returns Samuel 43500

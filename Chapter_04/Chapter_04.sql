...
COPY table_name
FROM 'C:\SQL1\Chapter_04\your_file.csv'
...
FROM 'C:\SQL1\Chapter_04\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\SQL1\Chapter_04\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\SQL1\Chapter_04\us_counties_export.txt'
...
TO 'C:\SQL1\Chapter_04\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'C:\SQL1\Chapter_04\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');

--Try it yourself
-- Chapter 4

--error when running the code - it does not exist.
COPY actors
FROM 'C:\SQL1\Chapter_04\movies.txt'
WITH (FORMAT CSV, HEADER, DELIMITER ':', QUOTE '#');

-- To import the data, saved in movies.txt
-- creating the actors table below and then running the copy statement
DROP TABLE actors;
CREATE TABLE actors (
    id integer,
    movie text,
...
TO 'C:\SQL1\Chapter_04\us_counties_housing_export.txt'
WITH (FORMAT CSV, HEADER);
...
-- Question 3
-- the total digits that can be held is 8. the scale is 3.
numeric(8,3)
